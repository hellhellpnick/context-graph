---
description: "Mirror — `.cursor/rules/` (4 files, part 13/20)"
...
- `.cursor/rules/ctxgraph--src-graph-builder-extract-exports.mdc` (54 lines · 7 top-level symbols) — # When to Read
