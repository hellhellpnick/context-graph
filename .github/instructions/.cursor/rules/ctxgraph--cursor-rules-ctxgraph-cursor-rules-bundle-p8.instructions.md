---
description: "Mirror — `.cursor/rules/ctxgraph--cursor-rules-ctxgraph-cursor-rules-bundle-p8.mdc`"
applyTo: ".cursor/rules/ctxgraph--cursor-rules-ctxgraph-cursor-rules-bundle-p8.mdc"
priority: "P2"
last_updated: "2026-05-29"
---

## When to Read
- editing or refactoring `ctxgraph--cursor-rules-ctxgraph-cursor-rules-bundle-p8.mdc`

## Overview
- `.cursor/rules/ctxgraph--cursor-rules-ctxgraph-cursor-rules-bundle-p8.mdc` (175 lines · 64 top-level symbols) — # When to Read

## Graph
```mermaid
graph LR
  ctxgraph__cursor_rules_ctxgraph_cursor_rules_bundle_p8[ctxgraph--cursor-rules-ctxgraph-cursor-rules-bundle-p8]
  ctxgraph__cursor_rules_ctxgraph_cursor_rules_bundle_p8 --> node[""]
  ctxgraph__cursor_rules_ctxgraph_cursor_rules_bundle_p8 --> package["package"]
```

## Signatures

```typescript
// ── .cursor/rules/ctxgraph--cursor-rules-ctxgraph-cursor-rules-bundle-p8.mdc ──
