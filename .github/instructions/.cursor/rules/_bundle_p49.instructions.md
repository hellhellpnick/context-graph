---
description: "Mirror — `.cursor/rules/` (4 files, part 49/51)"
...
## When to Read
- editing or refactoring `ctxgraph--src-source-extract-utils.mdc`
- editing or refactoring `ctxgraph--src-source-extract-vue-sfc.mdc`
- editing or refactoring `ctxgraph--src-writer.mdc`
- editing or refactoring `ctxgraph--test-bundle-p2.mdc`

## Overview
- `.cursor/rules/ctxgraph--src-source-extract-utils.mdc` (33 lines · 2 top-level symbols) — # When to Read
- `.cursor/rules/ctxgraph--src-source-extract-vue-sfc.mdc` (53 lines · 7 top-level symbols) — # When to Read
- `.cursor/rules/ctxgraph--src-writer.mdc` (45 lines · 4 top-level symbols) — # When to Read
- `.cursor/rules/ctxgraph--test-bundle-p2.mdc` (60 lines) — # When to Read
