---
description: "Mirror — `.cursor/rules/ctxgraph--cursor-rules-bundle-p2.mdc`"
applyTo: ".cursor/rules/ctxgraph--cursor-rules-bundle-p2.mdc"
priority: "P2"
...
## Overview
- `.cursor/rules/ctxgraph--cursor-rules-bundle-p2.mdc` (134 lines · 63 top-level symbols) — # When to Read

## Graph
```mermaid
graph LR
  ctxgraph__cursor_rules_bundle_p2[ctxgraph--cursor-rules-bundle-p2]
  ctxgraph__cursor_rules_bundle_p2 --> node[""]
```
