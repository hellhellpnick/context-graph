---
description: "Mirror — `.cursor/rules/ctxgraph--cursor-rules-bundle-p8.mdc`"
applyTo: ".cursor/rules/ctxgraph--cursor-rules-bundle-p8.mdc"
priority: "P2"
...
## Overview
- `.cursor/rules/ctxgraph--cursor-rules-bundle-p8.mdc` (177 lines · 64 top-level symbols) — # When to Read

## Graph
```mermaid
graph LR
  ctxgraph__cursor_rules_bundle_p8[ctxgraph--cursor-rules-bundle-p8]
  ctxgraph__cursor_rules_bundle_p8 --> node[""]
  ctxgraph__cursor_rules_bundle_p8 --> package["package"]
```
