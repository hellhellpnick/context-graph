---
description: "Mirror — `.cursor/rules/ctxgraph--cursor-rules-ctxgraph-cursor-rules-bundle-p9.mdc`"
applyTo: ".cursor/rules/ctxgraph--cursor-rules-ctxgraph-cursor-rules-bundle-p9.mdc"
priority: "P2"
last_updated: "2026-05-29"
---

## When to Read
- editing or refactoring `ctxgraph--cursor-rules-ctxgraph-cursor-rules-bundle-p9.mdc`

## Overview
- `.cursor/rules/ctxgraph--cursor-rules-ctxgraph-cursor-rules-bundle-p9.mdc` (155 lines · 69 top-level symbols) — # When to Read

## Graph
```mermaid
graph LR
  ctxgraph__cursor_rules_ctxgraph_cursor_rules_bundle_p9[ctxgraph--cursor-rules-ctxgraph-cursor-rules-bundle-p9]
  ctxgraph__cursor_rules_ctxgraph_cursor_rules_bundle_p9 --> node[""]
```

## Signatures

```typescript
// ── .cursor/rules/ctxgraph--cursor-rules-ctxgraph-cursor-rules-bundle-p9.mdc ──
// ── .cursor/rules/ctxgraph--cursor-rules-bundle-p9.mdc ──
...
export function humanAreaName(segment: string): string { let name = segment .replace(/\.[^.]+$/, '') // strip extension .replace(/^__(.+)__$/, '$1') // __init__ → init .replace(/[-_]+/g, ' ') // delim
