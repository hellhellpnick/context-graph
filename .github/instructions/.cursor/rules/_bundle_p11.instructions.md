---
description: "Mirror — `.cursor/rules/` (4 files, part 11/20)"
...
## Overview
- `.cursor/rules/ctxgraph--src-config.mdc` (73 lines · 12 top-level symbols) — # When to Read
- `.cursor/rules/ctxgraph--src-framework-extract.mdc` (51 lines · 10 top-level symbols) — # When to Read
- `.cursor/rules/ctxgraph--src-graph-builder-constants.mdc` (46 lines · 9 top-level symbols) — # When to Read
