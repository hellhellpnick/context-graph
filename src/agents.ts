...
function generateAgentsReadme(agents: FetchedAgent[]): string {
  ...
  const lines: string[] = [
    ...
    '',
    '## MANDATORY — repo routing (BLOCKING)',
    '',
    'Specialist agents **MUST NOT** replace the context graph. Before grep or broad repo search:',
    '',
    '1. **MUST** read `AGENTS.md` at repo root (or `CLAUDE.md` / tool-specific entry in that file).',
    '2. **MUST** open `.github/instructions/symbol-index.md` or `context-graph-path-index.md`.',
    '3. **MUST** open matching `.github/instructions/**/*.instructions.md` for files you edit.',
    '',
    '**FORBIDDEN:** repo-wide search before steps 2–3.',
    '',
    '## How to Use',
    '',
    '### GitHub Copilot',
