---
description: "Mirror — `.cursor/rules/ctxgraph--cursor-rules-bundle-p4.mdc`"
applyTo: ".cursor/rules/ctxgraph--cursor-rules-bundle-p4.mdc"
priority: "P2"
...
## Overview
- `.cursor/rules/ctxgraph--cursor-rules-bundle-p4.mdc` (111 lines · 44 top-level symbols) — # When to Read

## Graph
```mermaid
graph LR
  ctxgraph__cursor_rules_bundle_p4[ctxgraph--cursor-rules-bundle-p4]
```
