---
description: "Mirror — `.cursor/rules/ctxgraph--cursor-rules-bundle-p3.mdc`"
applyTo: ".cursor/rules/ctxgraph--cursor-rules-bundle-p3.mdc"
priority: "P2"
...
## Overview
- `.cursor/rules/ctxgraph--cursor-rules-bundle-p3.mdc` (140 lines · 52 top-level symbols) — # When to Read

## Graph
```mermaid
graph LR
  ctxgraph__cursor_rules_bundle_p3[ctxgraph--cursor-rules-bundle-p3]
  ctxgraph__cursor_rules_bundle_p3 --> node[""]
```
