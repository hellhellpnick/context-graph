---
description: "Mirror — `.cursor/rules/ctxgraph--cursor-rules-ctxgraph-cursor-rules-bundle-p23.mdc`"
applyTo: ".cursor/rules/ctxgraph--cursor-rules-ctxgraph-cursor-rules-bundle-p23.mdc"
priority: "P2"
last_updated: "2026-05-29"
---

## When to Read
- editing or refactoring `ctxgraph--cursor-rules-ctxgraph-cursor-rules-bundle-p23.mdc`

## Overview
- `.cursor/rules/ctxgraph--cursor-rules-ctxgraph-cursor-rules-bundle-p23.mdc` (128 lines · 49 top-level symbols) — # When to Read

## Graph
```mermaid
graph LR
  ctxgraph__cursor_rules_ctxgraph_cursor_rules_bundle_p23[ctxgraph--cursor-rules-ctxgraph-cursor-rules-bundle-p23]
  ctxgraph__cursor_rules_ctxgraph_cursor_rules_bundle_p23 --> node[""]
  ctxgraph__cursor_rules_ctxgraph_cursor_rules_bundle_p23 --> ENV{{"env / config"}}
```

## Signatures

```typescript
// ── .cursor/rules/ctxgraph--cursor-rules-ctxgraph-cursor-rules-bundle-p23.mdc ──
...
``" (`ctxgraph--cursor-rules-ctxgraph-cursor-rules-bundle-p23.mdc`)
