---
description: "Mirror — `.cursor/rules/` (3 files, part 1/51)"
...
## Overview
- `.cursor/rules/context-graph.mdc` (53 lines) — context-graph — AI routing entrypoint
- `.cursor/rules/ctxgraph--cursor-rules-bundle-p10.mdc` (89 lines · 16 top-level symbols) — # When to Read
- `.cursor/rules/ctxgraph--cursor-rules-bundle-p11.mdc` (52 lines · 6 top-level symbols) — # When to Read
