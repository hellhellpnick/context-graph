---
description: "Mirror — `.cursor/rules/` (4 files, part 1/20)"
...
## When to Read
- editing or refactoring `context-graph.mdc`
- editing or refactoring `ctxgraph--cursor-rules-bundle-p10.mdc`
- editing or refactoring `ctxgraph--cursor-rules-bundle-p11.mdc`
- editing or refactoring `ctxgraph--cursor-rules-bundle-p12.mdc`

## Overview
- `.cursor/rules/context-graph.mdc` (25 lines) — context-graph — AI routing entrypoint
- `.cursor/rules/ctxgraph--cursor-rules-bundle-p10.mdc` (56 lines · 10 top-level symbols) — # When to Read
- `.cursor/rules/ctxgraph--cursor-rules-bundle-p11.mdc` (82 lines · 20 top-level symbols) — # When to Read
- `.cursor/rules/ctxgraph--cursor-rules-bundle-p12.mdc` (76 lines · 19 top-level symbols) — # When to Read
...
export function buildSubsystemPassMessage( today: string, subsystemPath: string, rootGraphContent: string, scanPrompt: ScanResult, scanFull: ScanResult, sourceFiles: string[], planItem?: BuildPlanItem, passOpts?: { /* prompt template (~96 lines) */ }
 ...
 */
export function inferFilePriority( relPath: string, opts?: { /* ~71 lines */ }
