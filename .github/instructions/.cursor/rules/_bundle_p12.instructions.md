---
description: "Mirror — `.cursor/rules/` (4 files, part 12/20)"
...
## Overview
- `.cursor/rules/ctxgraph--src-graph-builder-deterministic-cursor-rules.mdc` (45 lines · 5 top-level symbols) — # When to Read
- `.cursor/rules/ctxgraph--src-graph-builder-deterministic-metadata.mdc` (41 lines · 3 top-level symbols) — # When to Read
- `.cursor/rules/ctxgraph--src-graph-builder-deterministic-root.mdc` (51 lines · 4 top-level symbols) — # When to Read
