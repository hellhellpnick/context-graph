---
description: "Mirror — `.cursor/rules/ctxgraph--cursor-rules-bundle-p22.mdc`"
applyTo: ".cursor/rules/ctxgraph--cursor-rules-bundle-p22.mdc"
priority: "P2"
...
## Overview
- `.cursor/rules/ctxgraph--cursor-rules-bundle-p22.mdc` (79 lines · 21 top-level symbols) — # When to Read

## Graph
```mermaid
graph LR
  ctxgraph__cursor_rules_bundle_p22[ctxgraph--cursor-rules-bundle-p22]
  ctxgraph__cursor_rules_bundle_p22 --> node[""]
```
