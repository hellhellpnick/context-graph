---
description: "Mirror — `.cursor/rules/` (4 files, part 5/15)"
...
## Overview
- `.cursor/rules/ctxgraph--src-cli-io.mdc` (50 lines · 5 top-level symbols) — # When to Read
- `.cursor/rules/ctxgraph--src-cli-program.mdc` (70 lines · 1 top-level symbols) — # When to Read
- `.cursor/rules/ctxgraph--src-cli-version.mdc` (38 lines · 1 top-level symbols) — # When to Read
- `.cursor/rules/ctxgraph--src-cli.mdc` (49 lines) — # When to Read
