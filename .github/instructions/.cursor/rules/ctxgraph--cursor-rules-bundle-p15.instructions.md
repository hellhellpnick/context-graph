---
description: "Mirror — `.cursor/rules/ctxgraph--cursor-rules-bundle-p15.mdc`"
applyTo: ".cursor/rules/ctxgraph--cursor-rules-bundle-p15.mdc"
priority: "P2"
...
## Overview
- `.cursor/rules/ctxgraph--cursor-rules-bundle-p15.mdc` (116 lines · 35 top-level symbols) — # When to Read

## Graph
```mermaid
graph LR
  ctxgraph__cursor_rules_bundle_p15[ctxgraph--cursor-rules-bundle-p15]
  ctxgraph__cursor_rules_bundle_p15 --> node[""]
  ctxgraph__cursor_rules_bundle_p15 --> ENV{{"env / config"}}
```
