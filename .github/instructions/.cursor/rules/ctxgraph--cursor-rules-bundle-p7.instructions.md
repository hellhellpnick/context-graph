---
description: "Mirror — `.cursor/rules/ctxgraph--cursor-rules-bundle-p7.mdc`"
applyTo: ".cursor/rules/ctxgraph--cursor-rules-bundle-p7.mdc"
priority: "P2"
...
```mermaid
graph LR
  ctxgraph__cursor_rules_bundle_p7[ctxgraph--cursor-rules-bundle-p7]
```
