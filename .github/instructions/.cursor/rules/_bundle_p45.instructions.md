---
description: "Mirror — `.cursor/rules/` (4 files, part 45/51)"
...
- editing or refactoring `ctxgraph--src-source-extract-csharp.mdc`
...
- `.cursor/rules/ctxgraph--src-source-extract-csharp.mdc` (33 lines · 2 top-level symbols) — # When to Read
