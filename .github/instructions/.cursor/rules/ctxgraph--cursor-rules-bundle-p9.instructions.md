---
description: "Mirror — `.cursor/rules/ctxgraph--cursor-rules-bundle-p9.mdc`"
applyTo: ".cursor/rules/ctxgraph--cursor-rules-bundle-p9.mdc"
priority: "P2"
last_updated: "2026-05-15"
---

## When to Read
- editing or refactoring `ctxgraph--cursor-rules-bundle-p9.mdc`

## Overview
- `.cursor/rules/ctxgraph--cursor-rules-bundle-p9.mdc` (100 lines · 43 top-level symbols) — # When to Read

## Graph
```mermaid
graph LR
  ctxgraph__cursor_rules_bundle_p9[ctxgraph--cursor-rules-bundle-p9]
  ctxgraph__cursor_rules_bundle_p9 --> node[""]
```
...
export function extractFilePurpose(content: string): string | null { /* ~42 lines */ }
