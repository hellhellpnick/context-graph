---
description: "Mirror — `.cursor/rules/ctxgraph--cursor-rules-bundle-p23.mdc`"
applyTo: ".cursor/rules/ctxgraph--cursor-rules-bundle-p23.mdc"
priority: "P2"
...
## Overview
- `.cursor/rules/ctxgraph--cursor-rules-bundle-p23.mdc` (136 lines · 49 top-level symbols) — # When to Read

## Graph
```mermaid
graph LR
  ctxgraph__cursor_rules_bundle_p23[ctxgraph--cursor-rules-bundle-p23]
  ctxgraph__cursor_rules_bundle_p23 --> node[""]
  ctxgraph__cursor_rules_bundle_p23 --> ENV{{"env / config"}}
```
...
``" (`ctxgraph--cursor-rules-bundle-p23.mdc`)
